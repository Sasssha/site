...
$(document).ready(function(){
	...
	function load_celling(celling_id,celling_type){
		...
		var png_file="http://918747.ru/natyazhnye-potolki/online_visualization/construct/celling/"+celling_id+"/"+celling_type+"-min.png";
		...
		$('.light').css('background-image','url("http://918747.ru/natyazhnye-potolki/online_visualization/construct/celling/'+celling_id+'/svet.png")');
		$('.light_l').css('background-image','url("http://918747.ru/natyazhnye-potolki/online_visualization/construct/lustr/min/'+celling_id+'-min.png")');
	...
	$(document).on('click','.select_oboi',function(){
		...
		$('.svg_wall').attr("oboi",o_id).css('background-image','url("http://918747.ru/natyazhnye-potolki/online_visualization/construct/oboi/'+o_id+'.jpg")');
